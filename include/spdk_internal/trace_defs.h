...
#define OWNER_TYPE_NVMF_OFI	0x31
#define OWNER_TYPE_NVME_OFI_HOST_QP	0x32
...
#define OBJECT_NVMF_OFI_IO	0x60
#define OBJECT_NVME_OFI_HOST_REQ	0x70
...
#define TRACE_GROUP_NVMF_OFI	0x7
...
#define TRACE_GROUP_NVME_OFI_HOST	0x13
...
/* NVMe-oF OFI tracepoint definitions */
#define TRACE_OFI_QP_CREATE		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x0)
#define TRACE_OFI_QP_DESTROY		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x1)
#define TRACE_OFI_RECV_CMD		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x2)
#define TRACE_OFI_SEND_CQE		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x3)
#define TRACE_OFI_RMA_READ		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x4)
#define TRACE_OFI_RMA_WRITE		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x5)
#define TRACE_OFI_CQ_ERROR		SPDK_TPOINT_ID(TRACE_GROUP_NVMF_OFI, 0x6)

/* NVMe-oF OFI host (initiator) tracepoint definitions — separate group/owner/object
 * from the target (lib/nvmf, group 0x7): nvmf_tgt links BOTH lib/nvmf and lib/nvme
 * (bdev_nvme), so reusing the target's IDs would double-register in that process. */
#define TRACE_NVME_OFI_HOST_QP_CREATE	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x0)
#define TRACE_NVME_OFI_HOST_QP_DESTROY	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x1)
#define TRACE_NVME_OFI_HOST_SUBMIT	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x2)
#define TRACE_NVME_OFI_HOST_COMPLETE	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x3)
#define TRACE_NVME_OFI_HOST_CQ_ERROR	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x4)
#define TRACE_NVME_OFI_HOST_CONNECT	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x5)
#define TRACE_NVME_OFI_HOST_MR_REG	SPDK_TPOINT_ID(TRACE_GROUP_NVME_OFI_HOST, 0x6)
